...
INSERT INTO "new_Question" ("commonMistake", "correctOption", "createdAt", "difficulty", "examId", "examSkillId", "explanationVi", "generatedViaJobId", "id", "knowledgeUnitId", "learningObjective", "optionA", "optionB", "optionC", "optionD", "passageId", "payload", "promptText", "questionCode", "responseFormat", "skill", "source", "sourceExam", "tags", "topic", "type", "updatedAt") SELECT "commonMistake", "correctOption", "createdAt", "difficulty", "examId", "examSkillId", "explanationVi", "generatedViaJobId", "id", "knowledgeUnitId", "learningObjective", "optionA", "optionB", "optionC", "optionD", "passageId", "payload", "promptText", "questionCode", "responseFormat", "skill", "source", "sourceExam", "tags", "topic", "type", "updatedAt" FROM "Question";
DROP TABLE "Question";
